    ...
    return (
      <div className='main'>
        ...
        <ul className='pokeList'>
          ...
          <li><PokemonList character={ this.state.list[this.state.card] } key={ this.state.list[this.state.card].id }/></li>
        </ul>
        <Route path="/pokemonpage/:age" render={ (props) => <PokemonPage {...props} data={ this.state.list[this.state.card] }/> }/>
        <Link to="/pokemonpage">redirect page</Link>
      </div>
    );
  }
}
