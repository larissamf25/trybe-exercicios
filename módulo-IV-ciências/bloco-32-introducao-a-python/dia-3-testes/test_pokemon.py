...
def test_retrieve_pokemons_by_type(grass_type_pokemon, water_type_pokemon):
    ...
    # quando pesquisamos por pokemons do tipo grama, o pokemon do tipo água não deve ser retornado
...
def test_retrieve_pokemons_by_type():
    ...
    # substituímos a função padrão do python open por mock_open, uma versão que se comporta de forma parecida, porém simulada
